import { Box, Avatar, Typography, Tooltip, IconButton, MenuItem, Divider, Button, MenuProps, styled, Menu } from "@mui/material";
      ...
      <>
        ...
        >
          <Box className="profile-img" position="relative">
            <Avatar alt="Remy Sharp" src='/images/profile/user-1.jpg' sx={{ height: 50, width: 50 }} />
          </Box>
        </Box>
        <IconButton
